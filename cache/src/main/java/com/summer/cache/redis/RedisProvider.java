package com.summer.cache.redis;
...
import tam.summer.common.properties.Prop;
import tam.summer.common.properties.Proper;
import tam.summer.common.serialize.Serializer;
...
public class RedisProvider
    ...
    private final static Logger logger = LogManager.getLogger(RedisProvider.class);
    ...
    static {
        Prop config = null;
        try {
            config = Proper.use("redis.properties.bak");
    ...
    private String getRedisKey(
            ...
            String key) {
        try {
            return new String((group + Constant.CONNECTOR + key).getBytes("ISO8859-1"), "utf-8");
